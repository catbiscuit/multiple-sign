...
namespace MultipleSign.Sign
{
    public class JiChangConsumer : ISignConsumer
    {
        ...
        private async Task<string> DoSign(JiChangDomainAccount jiChangDomainAccount)
        {
            ...
            RestResponse loginResponse = await client.ExecuteAsync(loginRequest);
